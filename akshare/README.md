...
│   ├── → 3.1 期货 / ✅ 3.2 期权
│   ├── ✅ 4.1 宏观 / 4.2 行业
│   ├── ✅ 5.1 外汇 / 5.2 加密货币 / 5.3 REITs / 5.4 QDII
│   ├── ✅ 6.1 龙虎榜+融资融券+沪深港通
│   ├── ✅ 7.1 空气质量+汽车数据+电影
│   └── ✅ 8.1 能源+利率
├── tests/                         # 测试文件
...
| `s5.3_test_reits.py` | 5.3 | REITs测试（17只，新浪替代） |
| `s5.3_demo_reits.py` | 5.3 | REITs综合演示（17只，新浪替代） |
| `s5.4_test_qdii.py` | 5.4 | QDII接口测试 |
| `s5.4_demo_qdii.py` | 5.4 | QDII综合演示：三大类涨幅排行 |
| `s6.1_test_market_micro.py` | 6 | 龙虎榜+融资融券+沪深港通测试 |
| `s6.1_demo_market_micro.py` | 6 | 市场微观综合演示：龙虎榜/两融/沪深港通 |
| `s7.1_test_alternative.py` | 7 | 空气质量+汽车+财富榜单+电影测试 |
| `s8.1_test_other.py` | 8 | 能源+利率扩展测试 |

> 所有脚本的详细说明见 `scripts/README.md`
> 完整路线图（17个阶段）见 `LEARNING_ROADMAP.md`
