...
| `s1.1_demo_stock.py` | 1.1 | 股票数据综合演示：历史+实时+分钟+技术指标+可视化 |
| `s1.1_demo_cross_signal.py` | 1.1 | 金叉死叉信号识别 + 均线策略回测 |
| `s1.1_tool_analysis.py` | 1.1 | 股票综合分析工具（多维度分析） |
| `s1.2_test_index.py` | 1.2 | 指数接口可用性验证（A股/港股/行业指数） |
